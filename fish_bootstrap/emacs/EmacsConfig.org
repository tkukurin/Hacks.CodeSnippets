...
* Emacs-evil tutorial: [[https://github.com/noctuid/evil-guide][Evil Guide]]
** Other refs
- [[https://sachachua.com/blog/2013/05/how-to-learn-emacs-a-hand-drawn-one-pager-for-beginners/][Emacs cheatsheet one-pager]]

** Basic commands
- Exit: =C-x C-c=
- Cancel: =C-g=
- Start emacs lisp mode: =eshell=
- Open links: =C-c C-o= or =M-x org-open-at-point= to open the link in your web browser.
- Dired: =C-x C-j= (cf. near end of this config)

* Config from *Emacs From Scratch*. Generates [[file:init.el][init.el]].
...
Emacs has a built in package manager but it doesn't make it easy to automatically install packages on a new system the first time you pull down your configuration.  [[https://github.com/jwiegley/use-package][use-package]] automates.
...
Prompts every few days to update packages.
...
[[https://github.com/emacscollective/no-littering/blob/master/no-littering.el][no-littering]] keeps folders where we edit files and the Emacs configuration folder clean!
...
- [[https://evil.readthedocs.io/en/latest/index.html][evil-mode]]: Vi-like modal editing experience.
- [[https://github.com/noctuid/general.el][general.el]]: keybinding configuration that integrates well with which-key
- [[https://github.com/emacs-evil/evil-collection][evil-collection]]: auto-configure various Emacs modes with Vi-like keybindings
...
** [[https://github.com/lewang/command-log-mode][command-log-mode]] displays keybindings in a side-panel
...
Run =M-x counsel-load-theme= to choose between them.
...
*NOTE:* you'll need to first-time run =M-x all-the-icons-install-fonts= so that mode line icons display correctly.
...
** Helpful Help Commands (figure out how Emacs works)

[[https://github.com/Wilfred/helpful][Helpful]] adds information to Emacs' =describe-= command buffers.
E.g. =describe-function= not only gets docs, but also the source code and where it gets used in other places in the Emacs configuration.
...
Check out the [[https://emacs-lsp.github.io/lsp-mode/page/languages/][documentation for your language]].
...
A set of UI enhancements built on top of =lsp-mode=.
Check out the screenshots on the =lsp-ui= homepage to see examples of what it can do.
